#!/usr/bin/env node
/**
 * Update Novel Cover URLs to Google Drive links
 * Reads .env and updates the novel cover_image field with Drive URLs
 */
...
async function updateCovers() {
  ...
  try {
    console.log('🔄 Updating novel cover URLs...\n');
    ...
    console.log('✨ All novel covers updated successfully!');
  } catch (error) {
