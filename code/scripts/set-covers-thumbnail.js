#!/usr/bin/env node
/**
 * Update Novel Cover URLs to use Google Drive thumbnail links
 */
...
async function updateCovers() {
  ...
  try {
    console.log('🔄 Updating novel cover URLs to Google Drive thumbnail links...\n');
    
    for (const update of coverUpdates) {
      const coverUrl = getThumbnailUrl(update.fileId);
    ...
    console.log('✨ All novel covers updated to Google Drive thumbnail links!');
  } catch (error) {
